 ...
 */
Ivan.base.discolor = function (pixes) {
    var grayscale;
 ...
 * @return {Array}
 */
Ivan.base.invert = function (pixes) {
    for (var i = 0, len = pixes.length; i < len; i += 4) {
 ...
 * @return {Array}
 */
Ivan.base.dodgeColor = function (basePixes, mixPixes) {
 ...
 * @return {Array}
 */
Ivan.base.gaussBlur = function (pixes, width, height, radius, sigma) {
    var gaussMatrix = [],
        gaussSum = 0,
        x, y,
        r, g, b, a,
